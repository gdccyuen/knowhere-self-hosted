...
# Keep provider details internal; only TELEMETRY_ENABLED is operator-facing.
export TELEMETRY_POSTHOG_HOST="https://us.i.posthog.com"
export TELEMETRY_POSTHOG_PROJECT_KEY="phc_5MQ7OffZTgxBejPdLMZ5mzxDg4jWHS4PFcbg9j5MmQm"
